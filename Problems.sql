...
Challenge: Return product_id, product_name, category_name, 2022 revenue and 2023 revenue decrease reatio and end Round the result
...
SELECT 
	...
	lys.revenue - cys.revenue as rev_diff,
	ROUND((cys.revenue - lys.revenue)::numeric/lys.revenue::numeric * 100, 2) as revenue_dec_ratio
FROM last_year_sale as lys
JOIN
current_year_sale as cys
ON cys.product_id = lys.product_id
...
/*
20. Store procedure
create a function as soon as product is sold the same quantity should reduced from inventory table
